...
void setup() {
  ...
  beginRecord(PDF, "design_201_v006.pdf");
...
void step3(boolean displayGuideLines) {
  ...
  myLineline0 = new Lineline(0, saveCircleX[0], saveCircleY[0], saveCircleX[2], saveCircleY[2], saveCircleX[7], saveCircleY[7], saveCircleX[1], saveCircleY[1], true, true, 'B', 1);
  myLineline0.displayIntersection();

  // diagonal 1 top of inner square
  myLineline1 = new Lineline(1, saveCircleX[0], saveCircleY[0], saveCircleX[2], saveCircleY[2], saveCircleX[1], saveCircleY[1], saveCircleX[3], saveCircleY[3], true, true, 'B', 1);
  myLineline1.displayIntersection();

  // top of inner square diagonal 2
  myLineline2 = new Lineline(2, saveCircleX[1], saveCircleY[1], saveCircleX[3], saveCircleY[3], saveCircleX[2], saveCircleY[2], saveCircleX[4], saveCircleY[4], true, true, 'B', 1);
  myLineline2.displayIntersection();

  // top of inner square diagonal 2
  myLineline3 = new Lineline(3, saveCircleX[2], saveCircleY[2], saveCircleX[4], saveCircleY[4], saveCircleX[3], saveCircleY[3], saveCircleX[5], saveCircleY[5], true, true, 'B', 1);
  myLineline3.displayIntersection();

  // left of inner square diagonal 3
  myLineline4 = new Lineline(4, saveCircleX[3], saveCircleY[3], saveCircleX[5], saveCircleY[5], saveCircleX[4], saveCircleY[4], saveCircleX[6], saveCircleY[6], true, true, 'B', 1);
  myLineline4.displayIntersection();

  // bottom of inner square diagonal 3
  myLineline5 = new Lineline(5, saveCircleX[4], saveCircleY[4], saveCircleX[6], saveCircleY[6], saveCircleX[5], saveCircleY[5], saveCircleX[7], saveCircleY[7], true, true, 'B', 1);
  myLineline5.displayIntersection();

  // bottom of inner square diagonal 4
  myLineline6 = new Lineline(6, saveCircleX[6], saveCircleY[6], saveCircleX[0], saveCircleY[0], saveCircleX[5], saveCircleY[5], saveCircleX[7], saveCircleY[7], true, true, 'B', 1);
  myLineline6.displayIntersection();

  // bottom of inner square diagonal 4
  myLineline7 = new Lineline(7, saveCircleX[7], saveCircleY[7], saveCircleX[1], saveCircleY[1], saveCircleX[6], saveCircleY[6], saveCircleX[0], saveCircleY[0], true, true, 'B', 1);
